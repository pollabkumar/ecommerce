                    ...
                    return (
                        <View style={{ flexDirection: "column", alignItems: "center", padding: 5, borderRadius: 8, backgroundColor: "#fff", marginVertical: 5, marginHorizontal: 5, elevation: 2 }}>
                            <View style={{ flexDirection: "row" }}>
                                <View style={{ flexDirection: "row", flex: 1.3, backgroundColor: "#f6f6f6", borderRadius: 8,padding: 3}}>
                                    <Image source={{ uri: item.image }} style={{ resizeMode: "contain", height: 130, width: "100%" }} />
                                </View>
